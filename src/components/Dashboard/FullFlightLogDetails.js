    ...
    return (
        <>
            <article className="flightDetails-card">
                <h5 className="flightlog_title">Flight Details</h5>
                <h3 className="card-title">{singleFlight.to} &rarr; {singleFlight.fromAirport}</h3>
                <div className="details_card" style={{width: "100rem"}} key={singleFlight.id}>
